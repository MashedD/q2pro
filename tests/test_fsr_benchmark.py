...
"""
    ...
    def test_frame_generation_telemetry_is_typed_and_summarized(self):
        parsed = fsr_benchmark.parse_benchmark_log(
            ...
            'provider=yes async_workloads=yes async_fallback=no disabled=no fallback_reason=none requested_total=4 '
        ...
        self.assertIs(parsed['frame_generation'][0]['async_fallback'], False)
        ...
        self.assertEqual(summary['async_workloads'], 1)
        self.assertEqual(summary['async_fallback'], 0)
