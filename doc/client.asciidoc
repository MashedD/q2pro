...
cl_itemhighlight_glow::
    Controls bloom intensity for item highlight tint shells. This does not add
    dynamic lights. Value 0 disables highlight bloom and keeps only the color
    tint. Higher values increase bloom strength, clamped to 5. Requires
