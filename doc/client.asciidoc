...
vk_raytracing::
    ...
    world surfaces. The ambient occlusion affects baked lighting but preserves
    emissive glow. A renderer restart is required. If the selected
...
vk_rt_emissive::
    ...
    surface angles. At most two nearby surface lights are evaluated per world
    face, with indices stored in the world mesh so ordinary face batching remains
    available. A renderer restart is required. Default value is 0.35; 0 disables
