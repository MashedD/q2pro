...
vk_rt_shadow_fringe::
    ...
    no passes, descriptors, or draws. Runtime transport quantizes specular and bounce controls to 7 bits
...
vk_rt_debug::
    ...
    colored dynamic-shadow fringe amplified eight times. Value 0 restores
