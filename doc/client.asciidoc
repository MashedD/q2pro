...
vk_rt_ao::
    ...
    surfaces, clamped between 0 and 0.5. A contact-focused sampling cone keeps
    corners and undersides distinct, including on moderately dark lightmap
    texels, while limiting overall scene darkening. Glowmapped pixels remain
