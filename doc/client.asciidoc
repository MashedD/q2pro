...
vk_rt_specular::
    ...
    `materials/rt_reflections.mat`; smooth materials receive focused glints
    while rough materials receive broader, weaker highlights. Changes apply
...
vk_rt_debug::
    ...
    reflection contribution. Value 0 restores
