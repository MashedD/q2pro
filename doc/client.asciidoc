...
vk_rt_emissive::
    ...
    additional rays. Emissive shadow contrast is reduced for large nearby source
    faces to approximate area-light softness without extra visibility samples.
    Influence lists remain in the world mesh so ordinary face batching stays available.
