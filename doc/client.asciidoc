...
vk_rt_specular::
    ...
    ray-shadow or baked-emissive visibility and adds no ray queries. It does
    ...
    `materials/rt_reflections.mat`; a 4-to-60 roughness-shaped,
    energy-normalized lobe
    gives smooth materials focused glints and rough materials broader visible
    highlights. Changes apply
