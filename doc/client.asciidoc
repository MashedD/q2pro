...
cl_itemhighlight::
    Adds colored tint to pickup items and visible weapons held by players.
    Health is green, armor is cyan, powerups are magenta, and weapon pickups
    use weapon-specific colors shared with their ammo where applicable.
...
cl_itemhighlight_glow::
    Controls bloom intensity for item and player highlight tint shells. This
